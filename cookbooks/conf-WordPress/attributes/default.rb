...
#
default['wp']['plugins'] = [ 'apc', '001-prime-strategy-translate-accelerator', 'backwpup', 'db-cache-reloaded-fix', 'easy-fancybox', 'pushpress', 'syntaxhighlighter', 'tinymce-advanced', 'wp-crontrol', 'wp-page-numbers', 'wp-social-bookmarking-light', 'wptouch', 'simple-login-lockdown' ]
#
# not used
